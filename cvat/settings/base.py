...
AUTH_ADFS = {
    "SERVER": "adfs.ltts.com",
    "CLIENT_ID": "dec6389c-23a4-4e85-bbb3-2442d9baada5",
    "RELYING_PARTY_ID": "dec6389c-23a4-4e85-bbb3-2442d9baada5",
    # Make sure to read the documentation about the AUDIENCE setting
    # when you configured the identifier as a URL!
    "AUDIENCE": "dec6389c-23a4-4e85-bbb3-2442d9baada5",
    'CLIENT_SECRET': 'f6121648-02de-4266-9fe1-3cc5f9ce2e86',
...
AWS_ACCESS_KEY_ID = 'AKIA6JBKZDWVZ2K4LG6P'
AWS_SECRET_ACCESS_KEY = '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'
AWS_STORAGE_BUCKET_NAME = 'adascloud'
